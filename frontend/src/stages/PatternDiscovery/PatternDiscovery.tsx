      ...
      <div className="flex-1 flex overflow-hidden min-h-0">
        ...
        >
          ...
          <div className="space-y-1.5">
            {[
              { id: 'stats', label: 'Stats Overview', icon: <BarChart3 className="w-3.5 h-3.5" />, visible: data && phase !== 'loading' },
              { id: 'sufficient', label: 'Dominant Patterns', icon: <CheckCircle2 className="w-3.5 h-3.5 text-emerald-500" />, visible: data && phase !== 'loading' },
              { id: 'insufficient', label: 'Non-Dominant Patterns', icon: <AlertCircle className="w-3.5 h-3.5 text-red-500" />, visible: data && showInsufficient },
              { id: 'helpMe', label: 'Fuzzy Patterns', icon: <HelpCircle className="w-3.5 h-3.5 text-amber-500" />, visible: data && hasHelpMe && showHelpMe },
            ].map((mod) => (
              <button
                key={mod.id}
                ...
                style={{
                  ...
                  background: mod.visible ? 'rgba(139,92,246,0.04)' : '#f9fafb',
                }}
              >
                {mod.visible ? (
                ...
                <span
                  ...
                  style={{ color: mod.visible ? '#374151' : '#9ca3af' }}
                >
                  {mod.label}
                </span>
              </button>
