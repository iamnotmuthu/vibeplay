...
const FAQ_CONTEXT: ContextDefinitionPayload = {
  ...
  guardrails: [
    // Safety
    {
      id: 'faq-safety-no-medical',
      category: 'safety',
      label: 'No Medical or Legal Advice',
      description: 'Never provide medical diagnoses, legal interpretations, or financial recommendations. Redirect to appropriate professionals.',
      enforcement: 'hard',
    },
    {
      id: 'faq-safety-no-pii-leak',
      category: 'safety',
      label: 'No PII Disclosure',
      description: 'Never expose personally identifiable information from one user to another. Mask account numbers in responses.',
      enforcement: 'hard',
    },
    // Quality
    {
      ...
      description: 'Only serve autonomous answers when retrieval confidence exceeds threshold. Below threshold, escalate or caveat.',
      enforcement: 'hard',
      threshold: '≥ 0.80',
    },
    {
      id: 'faq-quality-source-citation',
      category: 'quality',
      label: 'Source Citation Required',
      description: 'Every factual claim must cite the specific knowledge base article or FAQ entry it was derived from.',
      enforcement: 'soft',
    },
    // Escalation
    {
      id: 'faq-escalation-low-confidence',
      category: 'escalation',
      label: 'Low Confidence Handoff',
      description: 'Route to human agent when confidence drops below 80% or user explicitly requests a human.',
      enforcement: 'hard',
      threshold: '< 0.80 confidence OR user request',
    },
    {
      id: 'faq-escalation-sensitive-topic',
      category: 'escalation',
      label: 'Sensitive Topic Escalation',
      description: 'Immediately escalate billing disputes, account cancellations, and complaint escalations to tier-2 support.',
      enforcement: 'hard',
    },
    // Compliance
    {
      id: 'faq-compliance-data-retention',
      category: 'compliance',
      label: 'Conversation Data Retention',
      description: 'Retain conversation logs for 90 days per data retention policy. Purge PII after retention window.',
      enforcement: 'hard',
      threshold: '90-day retention window',
    },
    {
      id: 'faq-compliance-accessibility',
      category: 'compliance',
      label: 'Accessibility Standards',
      description: 'All responses must be screen-reader compatible. Avoid image-only answers without alt text.',
      enforcement: 'soft',
    },
  ],
}
...
const DOC_INTELLIGENCE_CONTEXT: ContextDefinitionPayload = {
  ...
  guardrails: [
    {
      id: 'doc-safety-no-contract-signing',
      category: 'safety',
      label: 'No Autonomous Contract Execution',
      description: 'Never approve, sign, or execute contracts. All contract decisions require human authorization.',
      enforcement: 'hard',
    },
    {
      id: 'doc-safety-confidential-handling',
      category: 'safety',
      label: 'Confidential Document Handling',
      description: 'Documents marked confidential must not be summarized in shared contexts or exported without authorization.',
      enforcement: 'hard',
    },
    {
      id: 'doc-quality-extraction-accuracy',
      category: 'quality',
      label: 'Extraction Accuracy Gate',
      description: 'Flag extracted values with OCR confidence below threshold for human verification before downstream use.',
      enforcement: 'hard',
      threshold: '≥ 0.95 OCR confidence',
    },
    {
      id: 'doc-quality-cross-reference',
      category: 'quality',
      label: 'Cross-Reference Validation',
      description: 'Amounts and dates must be cross-referenced against at least two document fields before reporting.',
      enforcement: 'soft',
    },
    {
      id: 'doc-escalation-high-value',
      category: 'escalation',
      label: 'High-Value Document Review',
      description: 'Contracts exceeding $50K or containing non-standard clauses must route to human review.',
      enforcement: 'hard',
      threshold: '> $50K or non-standard clause detected',
    },
    {
      id: 'doc-escalation-risk-flag',
      category: 'escalation',
      label: 'Risk Flag Escalation',
      description: 'Any document triggering 3+ risk rules escalates to the compliance team for manual review.',
      enforcement: 'hard',
      threshold: '≥ 3 risk rules triggered',
    },
    {
      id: 'doc-compliance-audit-trail',
      category: 'compliance',
      label: 'Immutable Audit Trail',
      description: 'Every extraction, classification, and decision must be logged to an append-only audit record.',
      enforcement: 'hard',
    },
    {
      id: 'doc-compliance-data-classification',
      category: 'compliance',
      label: 'Data Classification Tagging',
      description: 'All processed documents must be tagged with sensitivity level (public, internal, confidential, restricted).',
      enforcement: 'soft',
    },
  ],
}
...
const RESEARCH_CONTEXT: ContextDefinitionPayload = {
  ...
  guardrails: [
    {
      id: 'research-safety-no-fabrication',
      category: 'safety',
      label: 'No Source Fabrication',
      description: 'Never invent citations, authors, or publication details. Every reference must link to a verifiable source.',
      enforcement: 'hard',
    },
    {
      id: 'research-safety-bias-disclosure',
      category: 'safety',
      label: 'Bias Disclosure',
      description: 'Flag potential selection bias when search results cluster around a narrow set of sources or viewpoints.',
      enforcement: 'soft',
    },
    {
      id: 'research-quality-source-diversity',
      category: 'quality',
      label: 'Source Diversity Minimum',
      description: 'Final recommendations must draw from at least 3 independent sources to avoid single-source dependency.',
      enforcement: 'hard',
      threshold: '≥ 3 independent sources',
    },
    {
      id: 'research-quality-recency-check',
      category: 'quality',
      label: 'Recency Validation',
      description: 'Flag research older than 3 years as potentially outdated. Prioritize recent publications in ranking.',
      enforcement: 'soft',
      threshold: '≤ 3 years since publication',
    },
    {
      id: 'research-escalation-conflicting-evidence',
      category: 'escalation',
      label: 'Conflicting Evidence Alert',
      description: 'When top sources present contradictory findings, surface the conflict to the user rather than picking a side.',
      enforcement: 'hard',
    },
    {
      id: 'research-escalation-human-approval',
      category: 'escalation',
      label: 'Distribution Requires Approval',
      description: 'No research output may be distributed externally without explicit human approval.',
      enforcement: 'hard',
    },
    {
      id: 'research-compliance-copyright',
      category: 'compliance',
      label: 'Copyright Compliance',
      description: 'Limit direct quotes to fair-use lengths. Never reproduce full abstracts or papers without permission.',
      enforcement: 'hard',
    },
    {
      id: 'research-compliance-attribution',
      category: 'compliance',
      label: 'Proper Attribution',
      description: 'All findings must include complete citation metadata: author, title, year, DOI or URL.',
      enforcement: 'soft',
    },
  ],
}
...
const DENTAL_CONTEXT: ContextDefinitionPayload = {
  ...
  guardrails: [
    {
      id: 'dental-safety-no-clinical-decisions',
      category: 'safety',
      label: 'Zero Autonomous Clinical Decisions',
      description: 'Never diagnose conditions, recommend treatments, or interpret symptoms. All clinical matters route to licensed staff.',
      enforcement: 'hard',
    },
    {
      id: 'dental-safety-emergency-classification',
      category: 'safety',
      label: 'Emergency Fast-Track',
      description: 'Classify and escalate potential dental emergencies within 5 seconds. No autonomous handling of emergency symptoms.',
      enforcement: 'hard',
      threshold: '< 5 seconds classification time',
    },
    {
      id: 'dental-quality-insurance-verification',
      category: 'quality',
      label: 'Insurance Verification Accuracy',
      description: 'Coverage estimates must include disclaimer that actual benefits depend on plan verification at time of service.',
      enforcement: 'soft',
    },
    {
      id: 'dental-quality-appointment-confirmation',
      category: 'quality',
      label: 'Appointment Confirmation Required',
      description: 'All scheduled appointments must send confirmation to patient and office staff within 60 seconds.',
      enforcement: 'hard',
      threshold: '< 60 seconds confirmation delivery',
    },
    {
      id: 'dental-escalation-clinical-questions',
      category: 'escalation',
      label: 'Clinical Question Routing',
      description: 'Any question involving symptoms, pain, medication, or treatment options routes immediately to clinical staff.',
      enforcement: 'hard',
    },
    {
      id: 'dental-escalation-patient-distress',
      category: 'escalation',
      label: 'Patient Distress Detection',
      description: 'Detect emotional distress or urgency signals and escalate to human staff with priority flag.',
      enforcement: 'hard',
    },
    {
      id: 'dental-compliance-hipaa',
      category: 'compliance',
      label: 'HIPAA Compliance',
      description: 'All PHI access logged to immutable audit trail. AES-256 encryption at rest, TLS 1.3 in transit.',
      enforcement: 'hard',
    },
    {
      id: 'dental-compliance-consent-verification',
      category: 'compliance',
      label: 'Patient Consent Verification',
      description: 'Verify patient identity and consent before disclosing any appointment or insurance information.',
      enforcement: 'hard',
    },
  ],
}
...
const SAAS_COPILOT_CONTEXT: ContextDefinitionPayload = {
  ...
  guardrails: [
    {
      id: 'saas-safety-no-bulk-delete',
      category: 'safety',
      label: 'No Autonomous Bulk Deletion',
      description: 'Bulk delete operations (>10 records) are blocked without explicit user confirmation and a 10-second undo window.',
      enforcement: 'hard',
      threshold: '> 10 records requires confirmation',
    },
    {
      id: 'saas-safety-permission-boundary',
      category: 'safety',
      label: 'Permission Boundary Enforcement',
      description: 'Agent actions are limited to the requesting user\'s permission scope. No privilege escalation.',
      enforcement: 'hard',
    },
    {
      id: 'saas-quality-action-confirmation',
      category: 'quality',
      label: 'Two-Tier Confirmation Gate',
      description: 'Safe actions auto-confirm; sensitive operations (bulk updates, deletions, setting changes) require explicit approval.',
      enforcement: 'hard',
    },
    {
      id: 'saas-quality-action-preview',
      category: 'quality',
      label: 'Action Preview Before Execution',
      description: 'Show a preview of what will change before executing any write operation. Include record count and affected fields.',
      enforcement: 'soft',
    },
    {
      id: 'saas-escalation-high-impact',
      category: 'escalation',
      label: 'High-Impact Action Escalation',
      description: 'Actions affecting >100 records or modifying system-wide settings escalate to admin approval.',
      enforcement: 'hard',
      threshold: '> 100 records OR system-wide scope',
    },
    {
      id: 'saas-escalation-error-threshold',
      category: 'escalation',
      label: 'Error Rate Escalation',
      description: 'If >5% of actions in a session fail, pause execution and alert the user before continuing.',
      enforcement: 'hard',
      threshold: '> 5% session error rate',
    },
    {
      id: 'saas-compliance-audit-log',
      category: 'compliance',
      label: 'Immutable Action Audit Log',
      description: 'Every action (create, update, delete) logged with user ID, timestamp, before/after state, and approval status.',
      enforcement: 'hard',
    },
    {
      id: 'saas-compliance-data-export-controls',
      category: 'compliance',
      label: 'Data Export Controls',
      description: 'Exports exceeding 10K records require admin approval. All exports logged with destination and purpose.',
      enforcement: 'hard',
      threshold: '> 10K records requires admin approval',
    },
  ],
}
...
const OPS_AGENT_CONTEXT: ContextDefinitionPayload = {
  ...
  guardrails: [
    {
      id: 'ops-safety-no-production-write',
      category: 'safety',
      label: 'No Direct Production Writes',
      description: 'Agent cannot write directly to production databases. All changes go through the migration pipeline with checkpoints.',
      enforcement: 'hard',
    },
    {
      id: 'ops-safety-rollback-required',
      category: 'safety',
      label: 'Rollback Plan Required',
      description: 'Every migration must have a verified rollback plan before execution begins. No rollback = no execution.',
      enforcement: 'hard',
    },
    {
      id: 'ops-quality-checkpoint-validation',
      category: 'quality',
      label: 'Checkpoint Validation',
      description: 'Validate data integrity at every checkpoint. Halt migration if validation failure rate exceeds threshold.',
      enforcement: 'hard',
      threshold: '< 0.1% validation failure rate',
    },
    {
      id: 'ops-quality-resource-limits',
      category: 'quality',
      label: 'Resource Usage Limits',
      description: 'Job execution must not exceed allocated compute and memory. Auto-throttle when approaching 80% capacity.',
      enforcement: 'hard',
      threshold: '≤ 80% resource utilization',
    },
    {
      id: 'ops-escalation-failure-threshold',
      category: 'escalation',
      label: 'Failure Threshold Escalation',
      description: 'After 3 consecutive retry failures, halt the job and escalate to the on-call engineer.',
      enforcement: 'hard',
      threshold: '≥ 3 consecutive failures',
    },
    {
      id: 'ops-escalation-sla-breach',
      category: 'escalation',
      label: 'SLA Breach Alert',
      description: 'Alert operations team when job execution time exceeds 75% of SLA window.',
      enforcement: 'hard',
      threshold: '> 75% of SLA window elapsed',
    },
    {
...
const CODING_AGENT_CONTEXT: ContextDefinitionPayload = {
  ...
  guardrails: [
    {
      id: 'code-safety-no-auto-merge',
      category: 'safety',
      label: 'No Autonomous Merge to Main',
      description: 'Agent cannot merge code to main/production branches. All merges require human review and approval.',
      enforcement: 'hard',
    },
    {
      id: 'code-safety-sandbox-execution',
      category: 'safety',
      label: 'Sandbox-Only Execution',
      description: 'All generated code runs in isolated sandbox with 10-second timeout. No direct access to production systems.',
      enforcement: 'hard',
      threshold: '10-second execution timeout',
    },
    {
      id: 'code-quality-test-coverage',
      category: 'quality',
      label: 'Test Coverage Requirement',
      description: 'Generated code must include test cases covering happy path, edge cases, and error conditions.',
      enforcement: 'soft',
    },
    {
      id: 'code-quality-style-compliance',
      category: 'quality',
      label: 'Style Guide Compliance',
      description: 'All generated code must pass linting and conform to the project style guide before submission.',
      enforcement: 'soft',
    },
    {
      id: 'code-escalation-security-vulnerability',
      category: 'escalation',
      label: 'Security Vulnerability Detection',
      description: 'Flag potential security vulnerabilities (SQL injection, XSS, auth bypass) for security team review.',
      enforcement: 'hard',
    },
    {
      id: 'code-escalation-breaking-change',
      category: 'escalation',
      label: 'Breaking Change Alert',
      description: 'Changes affecting public APIs or shared interfaces must be flagged as breaking changes for team review.',
      enforcement: 'hard',
    },
    {
      id: 'code-compliance-license-check',
      category: 'compliance',
      label: 'License Compatibility Check',
      description: 'Verify that any imported dependencies have licenses compatible with the project license.',
      enforcement: 'soft',
    },
    {
      id: 'code-compliance-no-secrets',
      category: 'compliance',
      label: 'No Hardcoded Secrets',
      description: 'Never include API keys, passwords, tokens, or credentials in generated code. Use environment variables.',
      enforcement: 'hard',
    },
  ],
}
...
const ONPREM_ASSISTANT_CONTEXT: ContextDefinitionPayload = {
  ...
  guardrails: [
    {
      id: 'onprem-safety-air-gap',
      category: 'safety',
      label: 'Air-Gap Enforcement',
      description: 'Zero external API calls. All processing stays within classified network perimeter. No data exfiltration paths.',
      enforcement: 'hard',
    },
    {
      id: 'onprem-safety-classification-ceiling',
      category: 'safety',
      label: 'Classification Ceiling',
      description: 'Agent output classification cannot exceed the lowest classification of input documents used.',
      enforcement: 'hard',
    },
    {
      id: 'onprem-quality-output-sanitization',
      category: 'quality',
      label: 'Output Sanitization',
      description: 'All outputs pass through sanitization filter to prevent inadvertent disclosure of classified markings.',
      enforcement: 'hard',
    },
    {
      id: 'onprem-quality-encryption-validation',
      category: 'quality',
      label: 'Encryption Validation',
      description: 'Verify AES-256 encryption at rest and TLS 1.3 in transit for every data operation.',
      enforcement: 'hard',
    },
    {
      id: 'onprem-escalation-classification-conflict',
      category: 'escalation',
      label: 'Classification Conflict Resolution',
      description: 'When documents have conflicting classification markings, escalate to security officer for resolution.',
      enforcement: 'hard',
    },
    {
      id: 'onprem-escalation-anomaly-detection',
      category: 'escalation',
      label: 'Anomaly Detection Alert',
      description: 'Unusual access patterns or query volumes trigger security team notification.',
      enforcement: 'hard',
    },
    {
      id: 'onprem-compliance-fedramp',
      category: 'compliance',
      label: 'FedRAMP Compliance',
      description: 'All operations must conform to FedRAMP High baseline controls. Continuous monitoring required.',
      enforcement: 'hard',
    },
    {
      id: 'onprem-compliance-itar',
      category: 'compliance',
      label: 'ITAR Export Controls',
      description: 'Defense-related technical data must not be accessible to non-US persons. Access controls validated per session.',
      enforcement: 'hard',
    },
  ],
}
...
const MULTIMODAL_AGENT_CONTEXT: ContextDefinitionPayload = {
  ...
  guardrails: [
    {
      id: 'multi-safety-content-filtering',
      category: 'safety',
      label: 'Content Safety Filtering',
      description: 'Screen all uploaded media for harmful, illegal, or explicit content before processing. Block and report violations.',
      enforcement: 'hard',
    },
    {
      id: 'multi-safety-no-deepfake',
      category: 'safety',
      label: 'No Deepfake Generation',
      description: 'Never generate, modify, or synthesize media that impersonates real individuals.',
      enforcement: 'hard',
    },
    {
      id: 'multi-quality-transcription-accuracy',
      category: 'quality',
      label: 'Transcription Accuracy Gate',
      description: 'Flag transcription segments with word error rate above threshold for human review.',
      enforcement: 'soft',
      threshold: '≤ 5% word error rate',
    },
    {
      id: 'multi-quality-modality-attribution',
      category: 'quality',
      label: 'Modality Source Attribution',
      description: 'Every insight in cross-modal analysis must cite which source modality (text, image, audio) it derived from.',
      enforcement: 'soft',
    },
    {
      id: 'multi-escalation-unrecognized-format',
      category: 'escalation',
      label: 'Unrecognized Format Handling',
      description: 'Media in unsupported or corrupted formats escalates to user with clear error message rather than silent failure.',
      enforcement: 'hard',
    },
    {
      id: 'multi-escalation-processing-timeout',
      category: 'escalation',
      label: 'Processing Timeout Alert',
      description: 'Media processing exceeding 60 seconds alerts the user with progress update and estimated completion time.',
      enforcement: 'soft',
      threshold: '> 60 seconds processing time',
    },
    {
      id: 'multi-compliance-media-rights',
      category: 'compliance',
      label: 'Media Rights Verification',
      description: 'User must confirm they have rights to process uploaded media. Agent logs rights acknowledgment.',
      enforcement: 'soft',
    },
    {
      id: 'multi-compliance-retention-policy',
      category: 'compliance',
      label: 'Media Retention Policy',
      description: 'Processed media and transcripts deleted after 24 hours unless user opts for extended storage.',
      enforcement: 'hard',
      threshold: '24-hour default retention',
    },
  ],
}
...
const CONSUMER_CHAT_CONTEXT: ContextDefinitionPayload = {
  ...
  guardrails: [
    {
      id: 'consumer-safety-no-financial-advice',
      category: 'safety',
      label: 'No Financial Advice',
      description: 'Never provide financial, investment, or insurance advice. Redirect to qualified professionals.',
      enforcement: 'hard',
    },
    {
      id: 'consumer-safety-child-protection',
      category: 'safety',
      label: 'Minor Protection',
      description: 'Detect indicators of minor users and restrict interactions to age-appropriate content and products.',
      enforcement: 'hard',
    },
    {
      id: 'consumer-quality-tone-consistency',
      category: 'quality',
      label: 'Brand Tone Consistency',
      description: 'Maintain friendly, helpful, on-brand tone. Never adversarial, dismissive, or overly formal.',
      enforcement: 'soft',
    },
    {
      id: 'consumer-quality-resolution-tracking',
      category: 'quality',
      label: 'Resolution Confirmation',
      description: 'Before closing an issue, confirm with the customer that their problem is actually resolved.',
      enforcement: 'soft',
    },
    {
      id: 'consumer-escalation-complaint',
      category: 'escalation',
      label: 'Complaint Escalation',
      description: 'Escalate to human agent after 2 failed resolution attempts or when customer expresses frustration.',
      enforcement: 'hard',
      threshold: '≥ 2 failed resolution attempts OR frustration detected',
    },
    {
      id: 'consumer-escalation-refund-limit',
      category: 'escalation',
      label: 'Refund Authorization Limit',
      description: 'Autonomous refund authorization up to $50. Higher amounts require supervisor approval.',
      enforcement: 'hard',
      threshold: '≤ $50 autonomous refund limit',
    },
    {
      id: 'consumer-compliance-gdpr-ccpa',
      category: 'compliance',
      label: 'Privacy Regulation Compliance',
      description: 'Honor GDPR/CCPA data subject requests. Process deletion requests within 72 hours.',
      enforcement: 'hard',
      threshold: '< 72 hours for deletion requests',
    },
    {
      id: 'consumer-compliance-marketing-consent',
      category: 'compliance',
      label: 'Marketing Consent Required',
      description: 'Product recommendations must respect marketing opt-in preferences. No unsolicited promotions to opted-out users.',
      enforcement: 'hard',
    },
  ],
}
