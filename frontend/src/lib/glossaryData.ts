...
export const glossaryEntries: GlossaryEntry[] = [
  // ── Data Concepts (Stage 3) ────────────────────────────────────────────────
  {
    ...
    relatedTerms: ['numerical', 'define-bands', 'categorical'],
    stages: [3],
  },
  {
    term: 'numerical',
    displayName: 'Numerical Feature',
    shortDefinition: 'A data column containing numbers that can be measured and compared, like age, price, or monthly charges.',
    fullDefinition: 'Numerical features hold continuous or discrete numeric values — things you can add, average, or rank. Examples include tenure in months, monthly bill amount, or number of support calls. The model can learn thresholds and gradients from these values.',
    whyItMatters: 'Numerical features often carry the strongest signals in structured datasets. VibeModel analyses their distribution to decide whether to split them into bands or use them as-is.',
    category: 'data-concept',
  ...
  },
  {
    ...
    category: 'data-concept',
    relatedTerms: ['numerical', 'one-hot-encoding'],
    stages: [3],
  },
  {
    term: 'define-bands',
    ...
    category: 'data-concept',
    relatedTerms: ['numerical', 'dimensions'],
    stages: [3],
  },
  {
    term: 'missing-values',
