...
export function DomainSelector({ onSelect, embedded = false }: DomainSelectorProps) {
    ...
    return (
        <div
            className={embedded ? 'flex flex-col relative' : 'min-h-screen flex flex-col relative overflow-hidden'}
            style={{
                background: '#fafafa',
                color: '#1e293b',
            }}
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                {/* Content */}
                                                <div className="flex-1">
                                                    <p className="text-xs font-semibold uppercase tracking-wider mb-2" style={{ color: scenario.color }}>
                                                        {scenario.label}
                                                    </p>
                                                ...
                                                <div
                                                    ...
                                                    style={{ borderTop: '1px solid #f3f4f6' }}
                                                >
                                                    <p className="text-xs font-semibold leading-snug" style={{ color: scenario.color }}>
